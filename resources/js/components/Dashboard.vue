        ...
        <div class="border-4 border-dashed border-gray-200 rounded-lg p-8">
          <div class="text-center">
            <div class="mx-auto h-16 w-16 bg-primary-100 rounded-full flex items-center justify-center mb-4">
              <IconFileText class="h-8 w-8 text-primary-600" />
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div class="bg-white p-6 rounded-lg shadow">
                <div class="text-primary-600 mb-2">
                  <IconClipboardList class="h-8 w-8 mx-auto" />
                </div>
              ...
              <div class="bg-white p-6 rounded-lg shadow">
                <div class="text-primary-600 mb-2">
                  <IconFileText class="h-8 w-8 mx-auto" />
                </div>
              ...
              <div class="bg-white p-6 rounded-lg shadow">
                <div class="text-primary-600 mb-2">
                  <IconUsers class="h-8 w-8 mx-auto" />
                </div>
...
// Tabler Icons
import { IconFileText, IconClipboardList, IconUsers } from '@tabler/icons-vue'
