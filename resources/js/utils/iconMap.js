// SVG path 到 Lucide icon 的映射
export const svgToLucideMap = {
  // User icons
  ...
  'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z': 'Settings',
  
  // Clipboard/List icons
  'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01': 'UserCheck',
  ...
  // Profile icons
  'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z': 'UserCircle'
}

// 常用 Lucide icons 清單
export const commonLucideIcons = [
  'User', 'Users', 'UserCheck', 'UserCircle', 'UserPlus',
  'Building', 'Home', 'Settings', 'Cog',
  'ChevronDown', 'ChevronUp', 'ChevronLeft', 'ChevronRight',
  'Plus', 'Minus', 'X', 'Check', 'Search',
  'Edit', 'Trash2', 'Eye', 'EyeOff',
  'Mail', 'Phone', 'MapPin', 'Calendar',
  'LogOut', 'LogIn', 'Shield', 'AlertCircle',
